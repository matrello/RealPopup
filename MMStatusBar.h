...
// warning: modified by matro! see in-class comments //
...
public:
  CToolTipCtrl m_oToolTip;
	...
	// **class member added by Matro, 25/12/2003 **
	// trick to use this class in a CDialog derived form
	virtual LRESULT MMStatusBar::OnIdleUpdateCmdUI(WPARAM wParam, LPARAM);
